...
const RENTAL_FALLBACK_TEMPLATES: Record<string, { asunto: string; cuerpo_html: string }> = {
  ...
  rental_en_revision: {
    asunto: 'Estamos revisando tu solicitud — {{unit_name}}',
    cuerpo_html: `<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#f5f5f5;font-family:Georgia,serif"><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:32px 16px"><table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden"><tr><td style="background:#92400e;padding:28px 32px"><p style="margin:0;color:#fde68a;font-size:12px;letter-spacing:2px;text-transform:uppercase">En proceso</p><h1 style="margin:6px 0 0;color:#fff;font-size:22px;font-weight:normal">Revisando tu solicitud</h1></td></tr><tr><td style="padding:32px"><p style="margin:0 0 16px;color:#374151;font-size:15px">Hola <strong>{{guest_name}}</strong>,</p><p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.6">Tu solicitud para <strong>{{unit_name}}</strong> está siendo revisada por nuestro equipo. Te informaremos del resultado en los próximos días.</p>{{#if notas}}<div style="background:#fffbeb;border:1px solid #fde68a;border-radius:6px;padding:16px;margin-bottom:24px"><p style="margin:0;color:#92400e;font-size:14px">{{notas}}</p></div>{{/if}}<p style="margin:0;color:#6b7280;font-size:14px">Contacto: <a href="mailto:{{property_email}}" style="color:#1c4532">{{property_email}}</a> · {{property_phone}}</p></td></tr><tr><td style="padding:16px 32px;border-top:1px solid #f3f4f6;text-align:center"><p style="margin:0;color:#9ca3af;font-size:12px">{{property_name}} · {{property_address}}</p></td></tr></table></td></tr></table></body></html>`,
  },
  rental_mensaje_admin: {
    asunto: '{{subject}}',
    cuerpo_html: `<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#f5f5f5;font-family:Georgia,serif"><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:32px 16px"><table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden"><tr><td style="background:#1c4532;padding:28px 32px"><p style="margin:0;color:#a7f3d0;font-size:12px;letter-spacing:2px;text-transform:uppercase">{{property_name}}</p><h1 style="margin:6px 0 0;color:#fff;font-size:22px;font-weight:normal">{{subject}}</h1></td></tr><tr><td style="padding:32px"><p style="margin:0 0 16px;color:#374151;font-size:15px">Hola <strong>{{guest_name}}</strong>,</p><div style="background:#f9fafb;border-radius:6px;padding:20px;margin-bottom:24px;color:#374151;font-size:15px;line-height:1.7;white-space:pre-wrap">{{message_body}}</div><p style="margin:0;color:#6b7280;font-size:14px">{{property_name}} · <a href="mailto:{{property_email}}" style="color:#1c4532">{{property_email}}</a> · {{property_phone}}</p></td></tr><tr><td style="padding:16px 32px;border-top:1px solid #f3f4f6;text-align:center"><p style="margin:0;color:#9ca3af;font-size:12px">{{property_name}} · {{property_address}}</p></td></tr></table></td></tr></table></body></html>`,
  },
  rental_solicitar_docs: {
    asunto: 'Documentación pendiente para tu solicitud — {{unit_name}}',
    cuerpo_html: `<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#f5f5f5;font-family:Georgia,serif"><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:32px 16px"><table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden"><tr><td style="background:#1e3a5f;padding:28px 32px"><p style="margin:0;color:#bfdbfe;font-size:12px;letter-spacing:2px;text-transform:uppercase">Documentación</p><h1 style="margin:6px 0 0;color:#fff;font-size:22px;font-weight:normal">Necesitamos tu documentación</h1></td></tr><tr><td style="padding:32px"><p style="margin:0 0 16px;color:#374151;font-size:15px">Hola <strong>{{guest_name}}</strong>,</p><p style="margin:0 0 20px;color:#374151;font-size:15px;line-height:1.6">Para continuar con tu solicitud para <strong>{{unit_name}}</strong>, necesitamos que nos envíes la siguiente documentación:</p><ul style="margin:0 0 20px;padding-left:20px;color:#374151;font-size:15px;line-height:2">{{doc_list_html}}</ul>{{#if message_extra}}<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:6px;padding:16px;margin-bottom:20px"><p style="margin:0;color:#1e3a5f;font-size:14px">{{message_extra}}</p></div>{{/if}}<p style="margin:0;color:#374151;font-size:14px">Envía la documentación a <a href="mailto:{{property_email}}" style="color:#1c4532">{{property_email}}</a> o contacta con nosotros en {{property_phone}}.</p></td></tr><tr><td style="padding:16px 32px;border-top:1px solid #f3f4f6;text-align:center"><p style="margin:0;color:#9ca3af;font-size:12px">{{property_name}} · {{property_address}}</p></td></tr></table></td></tr></table></body></html>`,
  },
}
